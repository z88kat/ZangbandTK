...
static void project_feature_handler_MON_CHARM(project_feature_handler_context_t *context)
{
}

static void project_feature_handler_MON_CHARM_ANIMAL(project_feature_handler_context_t *context)
{
}

static void project_feature_handler_MON_CHARM_UNDEAD(project_feature_handler_context_t *context)
{
}

static void project_feature_handler_MON_PSI_DRAIN(project_feature_handler_context_t *context)
{
}
