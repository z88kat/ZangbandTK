...
EFFECT(LOSE_EXP,					false,	NULL,		1,		EFINFO_CONST,	"drains %d experience points",	"")
...
EFFECT(SUMMON_PET,					false,	NULL,		1,		EFINFO_SUMM,	"summons %s to serve you",	"summon %s")
...
EFFECT(CREATE_FOOD,					false,	NULL,		0,		EFINFO_NONE,	"conjures a ration of food at your feet",	"create food")
